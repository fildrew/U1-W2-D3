...
console.log("Esercizio 6:Total crew mass:", crewMass);
...
let neutralgenderCharacters = [];

for (let i = 0; i < starWarsCharacters.length; i++) {
  if (starWarsCharacters[i].gender === "n/a") {
    neutralgenderCharacters.push(starWarsCharacters[i]);
    starWarsCharacters[i].gender = "robot";
  }
}
console.log("Esercizio 8:", neutralgenderCharacters, starWarsCharacters);
...
console.log("Esercizio 9:Before,characterNames1 length:", charactersNames1.length);

for (let i = 0; i < starWarsCharacters.length; i++) {
  if (starWarsCharacters[i].gender === "female") {
    femaleCharacters1.splice(starWarsCharacters[i].name);
  }
}
console.log("Esercizio 9:After,characterNames1 length:", charactersNames1.length);
